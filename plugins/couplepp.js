...
cmd({
  ...
  try {
    _0x30d3fc("*𝙽𝙾𝚅𝙰 𝚇𝙳 💑 Fetching couple profile pictures...*");
    ...
    if (_0x5d4b91) {
      await _0x552520.sendMessage(_0x556c44, {
        ...
        'caption': " 𝙽𝙾𝚅𝙰 𝚇𝙳 𝚂𝚄𝙶𝙶𝙴𝚂𝚃𝚂: 👨 Male Couple Profile Picture"
      }, {
        'quoted': _0x51cf3f
      });
    }
    if (_0x5a1e4a) {
      await _0x552520.sendMessage(_0x556c44, {
        ...
        'caption': "𝙽𝙾𝚅𝙰 𝚇𝙳 𝚂𝚄𝙶𝙶𝙴𝚂𝚃𝚂 : 👩 Female Couple Profile Picture"
      }, {
        'quoted': _0x51cf3f
      });
    }
